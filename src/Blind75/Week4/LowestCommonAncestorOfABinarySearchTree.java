...
// 
// Related Topics Tree Depth-First Search Binary Search Tree Binary Tree 👍 7757
// 👎 230
...
class Solution {
    ...
    private TreeNode lowestCommonAncestorHelper(TreeNode root, TreeNode p, TreeNode q) {
        ...
        if (p.val < root.val && q.val < root.val)
            return this.lowestCommonAncestorHelper(root.left, p, q);
        else if (p.val > root.val && q.val > root.val)
            return this.lowestCommonAncestorHelper(root.right, p, q);
        else
            return root;
    }
